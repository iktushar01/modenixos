...
export function paletteToCssVars(colors: StorefrontColorPalette): Record<string, string> {
  return {
    ...
    "--sf-announcement": colors.primary,
    "--sf-announcement-fg": colors.primaryForeground,
    ...
    // Bridge shadcn/ui Tailwind tokens → storefront palette (scoped to .storefront-theme)
