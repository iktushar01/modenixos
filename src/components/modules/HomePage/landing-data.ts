...
export const pricingPlans: PricingPlan[] = [
  ...
  },
  {
    name: "Scale",
    monthlyPrice: null,
    desc: "For teams and high-volume sellers",
    features: [
      "Multiple stores",
      "Custom domains",
    ...
    cta: "Contact sales",
    href: "mailto:support@modenixos.com",
  },
];
...
export const faqs = [
  ...
  },
  {
    ...
    a: "Starter includes one store, up to 50 products, a public storefront, basic analytics, and guest checkout. No credit card required.",
  },
  {
