...
import { FileText, Image, Layers, LayoutTemplate, Palette, Store, Truck, CreditCard } from "lucide-react";
...
const LINKS = [
  ...
  { label: "Payments", href: "/dashboard/store/payments", icon: CreditCard },
